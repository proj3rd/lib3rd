...
export declare class grammar3rdParser extends Parser {
    ...
    static readonly RULE_characterStringType = 87;
    static readonly RULE_restrictedCharacterStringType = 88;
    static readonly RULE_objectClassFieldType = 89;
    static readonly RULE_setType = 90;
    static readonly RULE_setOfType = 91;
    static readonly RULE_referencedType = 92;
    static readonly RULE_definedType = 93;
    static readonly RULE_constraint = 94;
    static readonly RULE_constraintSpec = 95;
    static readonly RULE_userDefinedConstraint = 96;
    static readonly RULE_generalConstraint = 97;
    static readonly RULE_userDefinedConstraintParameter = 98;
    static readonly RULE_tableConstraint = 99;
    static readonly RULE_simpleTableConstraint = 100;
    static readonly RULE_contentsConstraint = 101;
    static readonly RULE_componentPresenceLists = 102;
    static readonly RULE_componentPresenceList = 103;
    static readonly RULE_componentPresence = 104;
    static readonly RULE_subtypeConstraint = 105;
    static readonly RULE_value = 106;
    static readonly RULE_builtinValue = 107;
    static readonly RULE_objectIdentifierValue = 108;
    static readonly RULE_objIdComponentsList = 109;
    static readonly RULE_objIdComponents = 110;
    static readonly RULE_integerValue = 111;
    static readonly RULE_choiceValue = 112;
    static readonly RULE_enumeratedValue = 113;
    static readonly RULE_signedNumber = 114;
    static readonly RULE_choiceType = 115;
    static readonly RULE_alternativeTypeLists = 116;
    static readonly RULE_extensionAdditionAlternatives = 117;
    static readonly RULE_extensionAdditionAlternativesList = 118;
    static readonly RULE_extensionAdditionAlternative = 119;
    static readonly RULE_extensionAdditionAlternativesGroup = 120;
    static readonly RULE_rootAlternativeTypeList = 121;
    static readonly RULE_alternativeTypeList = 122;
    static readonly RULE_namedType = 123;
    static readonly RULE_enumeratedType = 124;
    static readonly RULE_enumerations = 125;
    static readonly RULE_rootEnumeration = 126;
    static readonly RULE_enumeration = 127;
    static readonly RULE_enumerationItem = 128;
    static readonly RULE_namedNumber = 129;
    static readonly RULE_definedValue = 130;
    static readonly RULE_parameterizedValue = 131;
    static readonly RULE_simpleDefinedValue = 132;
    static readonly RULE_actualParameterList = 133;
    static readonly RULE_actualParameter = 134;
    static readonly RULE_exceptionSpec = 135;
    static readonly RULE_exceptionIdentification = 136;
    ...
    static readonly RULE_componentIdList = 144;
    static readonly RULE_octetStringType = 145;
    static readonly RULE_bitStringType = 146;
    static readonly RULE_namedBitList = 147;
    static readonly RULE_namedBit = 148;
    static readonly RULE_booleanValue = 149;
...
export declare class BuiltinTypeContext extends ParserRuleContext {
    ...
    characterStringType(): CharacterStringTypeContext | undefined;
...
export declare class RestrictedCharacterStringTypeContext extends ParserRuleContext {
    ...
    GRAPHIC_STRING_LITERAL(): TerminalNode | undefined;
    IA5_STRING_LITERAL(): TerminalNode | undefined;
    ISO646_STRING_LITERAL(): TerminalNode | undefined;
    NUMERIC_STRING_LITERAL(): TerminalNode | undefined;
    PRINTABLE_STRING_LITERAL(): TerminalNode | undefined;
    TELETEXT_STRING_LITERAL(): TerminalNode | undefined;
    T61_STRING_LITERAL(): TerminalNode | undefined;
    UNIVERSAL_STRING_LITERAL(): TerminalNode | undefined;
    UTF8_STRING_LITERAL(): TerminalNode | undefined;
